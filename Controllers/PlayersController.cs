...
namespace WebAppcoreGit1.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PId,Pname,PTeam")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PId,Pname,PTeam")] Player player)
        {
            if (id != player.PId)
            {
                return NotFound();
